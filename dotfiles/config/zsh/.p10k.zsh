...
() {
  ...
  typeset -g POWERLEVEL9K_RAM_ELEMENTS=(
    ram_free
  )
  ...
  # Defines extra space without background on the right side of right prompt
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='$(get_custom_icon)'
  ...
  typeset -g POWERLEVEL9K_USER_DEFAULT_BACKGROUND=008
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_VISUAL_IDENTIFIER_EXPANSION='󰄉 '
  # Custom prefix.
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=015
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=008
  # Custom icon.
